...
export const CAMERA = defineTuning("camera", "Run camera", {
  ...
  homeHeight: { default: 2.3, min: 0.2, max: 10, step: 0.05, label: "Home: height", unit: "m" },
  homeDistance: { default: 5.2, min: 0.5, max: 20, step: 0.05, label: "Home: distance behind", unit: "m" },
  homeLookHeight: { default: 1.1, min: -2, max: 5, step: 0.05, label: "Home: look-at height", unit: "m" },
